...
/* USER CODE BEGIN PFP */
extern void homing_on_exti(uint16_t pin);
extern void homing_arm_exti(void);
extern void homing_disarm_exti(void);
/* USER CODE END PFP */
...
extern volatile uint32_t player1_time;
extern volatile uint32_t player2_time;
